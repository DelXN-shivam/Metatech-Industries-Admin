    ...
    return (
      <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} shadow-sm rounded-lg p-4 mb-4`}>
        <div className="flex items-center space-x-2">
          ...
          <h2 className={`text-2xl font-bold ${darkMode ? 'text-gray-200' : 'text-gray-800'}`}>{fname}</h2>
          <div className="mt-2 text-sm text-gray-500">
            <span className={`items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${darkMode ? 'bg-blue-900 text-blue-300' : 'bg-blue-100 text-blue-800'}`}>
